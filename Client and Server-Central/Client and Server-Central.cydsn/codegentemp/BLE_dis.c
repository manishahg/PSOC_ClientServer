...
const CYBLE_DISS_T cyBle_diss =
{
    0x000Au,    /* Handle of the DIS service */
    {
        ...
        0x0010u, /* Handle of the Serial Number String characteristic */ 
        ...
        0x0016u, /* Handle of the Software Revision String characteristic */ 
        0x0018u, /* Handle of the System ID characteristic */ 
        0x001Au, /* Handle of the IEEE 11073-20601 Regulatory Certification Data List characteristic */ 
        0x001Cu, /* Handle of the PnP ID characteristic */ 
    },
};
